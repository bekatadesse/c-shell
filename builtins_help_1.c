...
/**
 * help_all - Displayys all possible builtin shellby commands.
 */
void help_all(void)
{
...
write(STDOUT_FILENO, msg, _strlen(msg));
msg = "out mmore about the function 'name'.\n\n alias  \t";
write(STDOUT_FILENO, msg, _strlen(msg));
...
/**
 * help_alias - Displays information on the the shellby builtin command 'alias'
 */
void help_alias(void)
{
...
/**
 * help_exit - Displays informationon the shellby builtin command 'exit'
 */
void help_exit(void)
{
